...
import type { QueueLinearState } from "./generateSteps";

export function Canvas({ step }: CanvasProps<QueueLinearState>) {
  ...
  return (
    <div className="flex h-full min-h-[300px] w-full items-center justify-center overflow-x-auto p-4 sm:p-8">
      <div className="flex items-center gap-2">
        {cells.map((cell, idx) => {
          const isFront = front === idx && front <= rear;
