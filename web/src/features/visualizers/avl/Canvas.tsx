          ...
          {nodes.map((node) => {
            ...
            return (
              ...
              >
                ...
                <div className={clsx(
                  "absolute -top-3 -right-3 flex items-center justify-center w-5 h-5 rounded-full text-[10px] font-black shadow-sm",
                  {
                    "bg-rose-500 text-white": node.balance > 1 || node.balance < -1,
                    "bg-emerald-500 text-white": node.balance >= -1 && node.balance <= 1,
                  }
                )}>
