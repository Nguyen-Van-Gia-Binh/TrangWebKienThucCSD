...
![Thuyết minh](https://img.shields.io/badge/Course-CSD201-blue.svg) ![Next.js](https://img.shields.io/badge/Next.js-14.x-black.svg) ![NestJS](https://img.shields.io/badge/NestJS-10.x-red.svg)
...
- **Kiến trúc Vượt trội**: 
  ...
  - Backend: `NestJS`, xử lý API tốc độ cao.

## 🚀 Hướng dẫn Cài đặt & Chạy (Local Development)

Dự án được chia làm 2 phần: `api` (Backend) và `web` (Frontend). Bạn cần bật cả 2 để web hoạt động đầy đủ.
